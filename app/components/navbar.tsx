	...
	return (
		<nav className="navbar bg-gray-100 px-4 h-14 flex justify-between items-center">
			<div className="flex items-center space-x-4 h-full">
				...
				<Link
					href="/projects"
					className="flex h-full justify-between items-center hover:underline"
				>
					Projects
				</Link>
				<Link
					href="/people"
					className="flex h-full justify-between items-center border-b-2 navbar-border-accent hover:underline"
				>
					<b>People</b>
				</Link>
			</div>
