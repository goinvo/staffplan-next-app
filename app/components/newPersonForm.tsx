        ...
        <form onSubmit={handleSubmit} className='flex flex-col'>
            <div className='flex flex-col mt-1 mb-1'>
                ...
                <input
                    ...
                    className="h-10 px-2 rounded-sm font-bold border-none focus:border-tiffany focus:ring-2 focus:ring-tiffany border-none focus:border-tiffany outlined-none y text-huge text-contrastBlue max-w-[370px]"
            ...
            <div className='flex flex-col mt-1 mb-1'>
                ...
                <input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className="h-10 px-2 text-huge font-bold border-none rounded-sm focus:border-tiffany focus:ring-2 focus:ring-tiffany border-none focus:border-tiffany outlined-none text-contrastBlue max-w-[370px]"
            ...
            <div className='flex flex-col mt-1 mb-1'>
                ...
                <input
                    ...
                    onChange={formik.handleChange}
                    onBlur={formik.handleBlur}
                    className="h-6 px-2 text-tiny font-normal focus:border-tiffany focus:ring-2 focus:ring-tiffany border-none focus:border-tiffany outlined-none text-contrastBlue max-w-[370px]"
                    placeholder="email"
                />
            ...
            <div className="flex items-center py-1 mt-1 mb-1">
                <input
                    ...
                    onChange={formik.handleChange}
                    id="adminCheckbox"
                    className="h-4 w-4 appearance-none border rounded-sm checked:bg-tiffany focus:outline-none focus:ring-2 focus:ring-tiffany transition-all"
                />
