...
export const UserLabel = ({ assignment, clickHandler }: UserLabelProps) => {
	...
	const assignmentDropMenuOptions = [
		{
			...
			onClick={() =>
				openModal(<EditAssignmentModal assignment={assignment} closeModal={closeModal} />)
			}
		>
			Edit Assignment
		</button>,
	...
	return (
		<div className="sm:ml-auto ml-0 sm:w-24 flex">
			...
			<EllipsisDropdownMenu options={assignmentDropMenuOptions} location={"userAssignment"} />
		</div>
	);
};
